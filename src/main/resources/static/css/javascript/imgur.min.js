!function (t, e) {
    ...
    return e.prototype = {
        createEls: function (t, e, i) {
            ...
            var e, i;
            e = this.createEls("p", {}, "Przeciągnij pliki ze zdjęciem lub kliknij w obszar."), i = this.createEls("input", {
                type: "file",
                multiple: "multiple",
                accept: "image/*"
            ...
            var t, e;
            t = this.createEls("div", {className: "loading-modal"}), e = this.createEls("img", {
                className: "loading-image"

            }), t.appendChild(e), document.body.appendChild(t)
        }, status: function (t) {
            var e = this.createEls("div", {className: "status"});
            ...
            i.addEventListener("change", function (t) {
                if (t.target && "INPUT" === t.target.nodeName && "file" === t.target.type)for (n = t.target.files, a = 0, s = n.length; a < s; a += 1)e = n[a], this.matchFiles(e, i)
